  ...
  .config(function ($stateProvider, $urlRouterProvider, baseURL) {
    ...
    $stateProvider
      ...
      .state('app.imagePage', {
        ...
        views: {
          'menuContent': {
            templateUrl: baseURL + "templates/image-page.html",
            controller: 'AppCtrl'
          }
        }
      })
      ...
      .state('app.contactProfile', {
        ...
        views: {
          'menuContent': {
            templateUrl: baseURL + "templates/contactProfile.html",
            controller: 'ContactProfileCtrl'
          }
        }
      })
      .state('app.captureImage', {
        url: "/captureImage",
        cache:false,
        views: {
          'menuContent': {
            templateUrl: baseURL + "templates/capture-Image.html",
            controller: 'captureImageCtrl'
            
          }
        }
        
...
        views: {
          'menuContent': {
            templateUrl: baseURL + "templates/liveChat.html",
